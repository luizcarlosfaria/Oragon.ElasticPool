...
namespace Oragon.AdaptivePool.RabbitMQ.Sample.BurstyPublisher;

/// <summary>
/// BackgroundService cycling idle → burst → idle, demonstrating the headline value
/// proposition of <c>Oragon.AdaptivePool</c>: pool grows under burst, shrinks during
...
public sealed class BurstyPublisherWorker(
    [FromKeyedServices("sample")] IAdaptivePool<IChannel> channelPool,
    ILogger<BurstyPublisherWorker> logger,
    IHostApplicationLifetime lifetime) : BackgroundService
{
    private const string Exchange = "oragon.adaptivepool.sample";
    private const string Queue = "oragon.adaptivepool.sample.queue";
