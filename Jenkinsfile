    ...
    stages {
        ...
        stage('Build') {
            ...
            steps {
                ...
                sh 'dotnet workload restore ./Oragon.ElasticPool.slnx'

                sh 'dotnet build ./Oragon.ElasticPool.slnx'
                ...
                withCredentials([usernamePassword(credentialsId: 'SonarQube', passwordVariable: 'SONARQUBE_KEY', usernameVariable: 'DUMMY' )])
                {
                    script
                    {
                        ...
                        sh  """
                            ...
                            dotnet restore  ./Oragon.ElasticPool.slnx

                            dotnet workload restore --framework net10.0 -p:TargetFrameworks=net10.0 ./Oragon.ElasticPool.slnx

                            export PATH="\$PATH:/root/.dotnet/tools"

                            dotnet sonarscanner begin ${sonarParamsText}

                            dotnet build --no-incremental --framework net10.0 -p:TargetFrameworks=net10.0 ./Oragon.ElasticPool.slnx
