...
<required_reading>
@/mnt/p/dynamic-pool/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/mnt/p/dynamic-pool/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /mnt/p/dynamic-pool/.claude
                  → checks /mnt/p/dynamic-pool/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /mnt/p/dynamic-pool/.claude/get-shit-done
                  → writes to /mnt/p/dynamic-pool/.claude/get-shit-done/hooks/
...
@/mnt/p/dynamic-pool/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/mnt/p/dynamic-pool/.claude/get-shit-done/references/common-bug-patterns.md
