...
Use template from `/mnt/p/dynamic-pool/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/mnt/p/dynamic-pool/.claude/get-shit-done/templates/UI-SPEC.md`
