...
<reference>
@/mnt/p/dynamic-pool/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/mnt/p/dynamic-pool/.claude/get-shit-done/references/user-profiling.md` to load:
