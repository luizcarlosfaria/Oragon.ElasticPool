...
Reference full template: `/mnt/p/dynamic-pool/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/mnt/p/dynamic-pool/.claude/get-shit-done/templates/state.md`.
