...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/update.md
</execution_context>
...
- Otherwise: **Follow the update workflow** from `@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/update.md`.
...
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/sync-skills.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/reapply-patches.md
</execution_context_extended>
