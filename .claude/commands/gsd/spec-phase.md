...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/spec-phase.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/templates/spec.md
</execution_context>
...
<process>
Execute the spec-phase workflow from @/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/spec-phase.md end-to-end.
