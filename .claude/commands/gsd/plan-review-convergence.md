...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/plan-review-convergence.md
...
<process>
Execute the plan-review-convergence workflow from @/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/plan-review-convergence.md end-to-end.
