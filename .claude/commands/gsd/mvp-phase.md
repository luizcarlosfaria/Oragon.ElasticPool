...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/mvp-phase.md end-to-end.
