...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/add-todo.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/note.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/add-backlog.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/plant-seed.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/check-todos.md
