...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/code-review.md
</execution_context>
...
Execute the code-review workflow from @/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/code-review.md end-to-end.
