...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/health.md
</execution_context>

<process>
Execute the health workflow from @/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/health.md end-to-end.
