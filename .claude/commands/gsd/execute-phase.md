...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/execute-phase.md end-to-end.
