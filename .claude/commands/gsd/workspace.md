...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/new-workspace.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/list-workspaces.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/remove-workspace.md
