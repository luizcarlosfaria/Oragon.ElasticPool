...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/add-phase.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/insert-phase.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/remove-phase.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/edit-phase.md
</execution_context>
