...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/quick.md
</execution_context>
...
Execute the quick workflow from @/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/quick.md end-to-end.
