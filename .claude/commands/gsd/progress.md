...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/progress.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/next.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/do.md
