...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/settings.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/settings-advanced.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/settings-integrations.md
</execution_context>
