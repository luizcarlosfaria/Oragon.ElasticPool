...
<execution_context>
@/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/plan-phase.md
...
<process>
Execute the plan-phase workflow from @/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/plan-phase.md end-to-end.
