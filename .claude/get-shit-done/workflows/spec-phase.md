...
```bash
INIT=$(node "/mnt/p/dynamic-pool/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/mnt/p/dynamic-pool/.claude/get-shit-done/templates/spec.md.
