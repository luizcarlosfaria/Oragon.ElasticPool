...
<template>
@/mnt/p/dynamic-pool/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/mnt/p/dynamic-pool/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/mnt/p/dynamic-pool/.claude/get-shit-done/workflows/diagnose-issues.md
