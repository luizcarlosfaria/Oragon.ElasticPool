...
INSTALL_JS_GLOBAL="/mnt/p/dynamic-pool/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /mnt/p/dynamic-pool/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
