...
```
Task(
  prompt="Read /mnt/p/dynamic-pool/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/mnt/p/dynamic-pool/.claude/get-shit-done/templates/VALIDATION.md`
