...
```bash
INIT=$(node "/mnt/p/dynamic-pool/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/mnt/p/dynamic-pool/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
