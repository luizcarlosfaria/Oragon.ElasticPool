...
Key references:
- @/mnt/p/dynamic-pool/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/mnt/p/dynamic-pool/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/mnt/p/dynamic-pool/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/mnt/p/dynamic-pool/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/mnt/p/dynamic-pool/.claude/get-shit-done/USER-PROFILE.md" "/mnt/p/dynamic-pool/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /mnt/p/dynamic-pool/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/mnt/p/dynamic-pool/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/mnt/p/dynamic-pool/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /mnt/p/dynamic-pool/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /mnt/p/dynamic-pool/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /mnt/p/dynamic-pool/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /mnt/p/dynamic-pool/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /mnt/p/dynamic-pool/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/mnt/p/dynamic-pool/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /mnt/p/dynamic-pool/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /mnt/p/dynamic-pool/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /mnt/p/dynamic-pool/.claude/CLAUDE.md
```
