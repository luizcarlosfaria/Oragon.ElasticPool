...
```markdown
Read /mnt/p/dynamic-pool/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /mnt/p/dynamic-pool/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /mnt/p/dynamic-pool/.claude/agents/gsd-ui-checker.md for instructions.
