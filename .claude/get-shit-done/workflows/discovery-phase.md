...
See /mnt/p/dynamic-pool/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /mnt/p/dynamic-pool/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /mnt/p/dynamic-pool/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /mnt/p/dynamic-pool/.claude/get-shit-done/templates/discovery.md
...
Use /mnt/p/dynamic-pool/.claude/get-shit-done/templates/discovery.md.
