...
<required_reading>
@/mnt/p/dynamic-pool/.claude/get-shit-done/references/ai-frameworks.md
@/mnt/p/dynamic-pool/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /mnt/p/dynamic-pool/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/mnt/p/dynamic-pool/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /mnt/p/dynamic-pool/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /mnt/p/dynamic-pool/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /mnt/p/dynamic-pool/.claude/agents/gsd-eval-planner.md for instructions.
