...
/// <summary>
/// Adapter-side fluent builder for an <c>IElasticPool&lt;IChannel&gt;</c>. Exposes the
...
public sealed class ElasticChannelPoolBuilder
{
    ...
    /// and <c>max &gt;= 1</c>.
    /// </summary>
    public ElasticChannelPoolBuilder WithBounds(int min, int max, int initial)
    {
        if (min < 0)
    ...
    /// </summary>
    public ElasticChannelPoolBuilder WithIdleTimeout(TimeSpan t)
    {
        if (t <= TimeSpan.Zero)
    ...
    /// </summary>
    public ElasticChannelPoolBuilder WithSweepInterval(TimeSpan t)
    {
        if (t <= TimeSpan.Zero)
    ...
    /// </summary>
    public ElasticChannelPoolBuilder WithShrinkOnUtilizationPercent(double p)
    {
        if (p < 0.0 || p > 1.0)
    ...
    /// Validates <c>p in (0, 1]</c>.
    /// </summary>
    public ElasticChannelPoolBuilder WithShrinkTargetUtilizationPercent(double p)
    {
        if (p <= 0.0 || p > 1.0)
    ...
    /// Validates <c>n &gt;= 1</c>.
    /// </summary>
    public ElasticChannelPoolBuilder WithShrinkBatchSize(int n)
    {
        if (n < 1)
    ...
    /// Validates <c>n &gt;= 0</c>.
    /// </summary>
    public ElasticChannelPoolBuilder WithShrinkCooldownWindows(int n)
    {
        if (n < 0)
    ...
    /// </summary>
    public ElasticChannelPoolBuilder WithMaxChannelsPerConnection(int n)
    {
        if (n < 1 || n > 2047)
