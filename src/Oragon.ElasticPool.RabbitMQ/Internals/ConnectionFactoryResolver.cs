...
using Oragon.ElasticPool.RabbitMQ.Options;
...
///   <item><description>IOptions: read <see cref="ElasticConnectionPoolOptions"/> via
...
internal static class ConnectionFactoryResolver
{
        ...
        Action<ConnectionFactory>? configureFactory)
    {
        ...
        var monitor = sp.GetService<IOptionsMonitor<ElasticConnectionPoolOptions>>();
